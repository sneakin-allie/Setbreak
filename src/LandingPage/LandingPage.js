        ...
        return (
            <div className="Landing-page">
                <h3>Keep track of concerts you've attended</h3>
                    <p className="Landing-page-p">Setbreak helps you keep track of concerts you've attended in one streamlined collection. Upload information about dates, artists, venues, highlights, and notes for each concert. All of your concerts in one collection!</p>
